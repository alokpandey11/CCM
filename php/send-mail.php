...
if ($mysqli->connect_error) {
    ...
    $query = "SELECT * FROM conflict where approved=1 AND sent=0 ";
    ...
    $i=1;
        ...
        while ($row = mysqli_fetch_array($result))
     {
            echo '<div class="w3-third w3-container w3-border-top w3-border-right w3-border-left col-height" style="padding: 10px;">
                  <a style="float: right; margin-right: 1vw;">';
                    echo $row['_date'];
            echo '</a><br><br><p style="float: left; margin-left: 1vw;">';
                    ...
                    echo '</p>
                    <form method="post" action="mail.php" style=""><input type="hidden" name="sno" value='; echo $row['sno'];
                    echo '><input type="submit" name="approve" value="Send" style="float: right; margin-right: 1.5vw; margin-top: 12vw; border: none;background-color: #e1ad01;color: white;padding: 4px 8px; text-decoration: none;cursor: pointer;"></form>';
                    echo '</div>';
