...
<body onload='showconflict("unsolved")'>
...
<header class="page-header">
  <nav>
    ...
    <ul class="admin-menu">
      ...
      <li class="menu-heading">
        <h3 style="color: #ffffff">Conflicts</h3>
      </li>
      <li>
        <a href="conflict.php">
          <svg>
          ...
          <span style="color: #ffffff">Conflicts</span>
        </a>
      </li>
     <!-- <li>
        <a href="#0">
      ...
      <li>
        <a href="Logout.php">
          <i class="fa fa-sign-out" style="width: 28px; font-size: 20px; color: #ffffff"></i>
...
<section class="page-content">
  ...
  <p style="margin-left: 1vw; font: 50px bold;">CONFLICTS</p><hr/><br><br>

  <div class="dropdown">
  <form >
  <SELECT name="conflictsol" onchange="showconflict(this.value)" >
   <!--<OPTION value="choose" selected> CHOOSE OPTION</OPTION>-->
   <OPTION value="unsolved" selected>UNRESOLVED</OPTION>
   <?php
   if($_SESSION['privilege']==1){
     echo '<OPTION value="approve">TO BE APPROVED</OPTION>';
     echo '<OPTION value="solved">RESOLVED</OPTION>';
   }
   else
   {
     echo '<OPTION value="solved_by_me">SOLVED BY ME</OPTION>';
   }
   ?>
</SELECT>
</form>
...
<div id="txtHint"><b>Conflict List will be shown here<b>
</div>
<script>
function showconflict(str) {
  if (str == "") {
    ...
    xmlhttp.open("GET","allconflict.php?q="+str,true);
    xmlhttp.send();
  }
}
</script>
